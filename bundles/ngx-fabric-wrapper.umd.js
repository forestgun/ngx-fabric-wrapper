(function (global, factory) {
    ...
    typeof define === 'function' && define.amd ? define(['exports', '@angular/core', 'fabric', '@angular/common'], factory) :
    (global = global || self, factory((global.zef = global.zef || {}, global.zef.ngxFabricWrapper = {}), global.ng.core, global.Fabric, global.ng.common));
     ...
     */
    /** @type {?} */
    var FABRIC_CONFIG = new core.InjectionToken('FABRIC_CONFIG');
    /** @type {?} */
    var FabricEvents = [
        'drop',
        'dragover',
    ...
    var FabricDirective = /** @class */ (function () {
        function FabricDirective(zone, elementRef, differs, defaults) {
            ...
            this.mousedblclick = new core.EventEmitter();
            this.mouseupBefore = new core.EventEmitter();
            this.mousedownBefore = new core.EventEmitter();
            this.mousemoveBefore = new core.EventEmitter();
            this.mouseUp = new core.EventEmitter();
            this.mouseDown = new core.EventEmitter();
            this.mouseOver = new core.EventEmitter();
            this.mouseOut = new core.EventEmitter();
            ...
            this.mouseDownBefore = new core.EventEmitter();
            this.mouseMoveBefore = new core.EventEmitter();
            this.pathCreated = new core.EventEmitter();
            this.alterRender = new core.EventEmitter();
            this.objectAdded = new core.EventEmitter();
            this.objectMoved = new core.EventEmitter();
            this.objectScaled = new core.EventEmitter();
            this.objectSkewed = new core.EventEmitter();
            this.objectRotated = new core.EventEmitter();
            this.objectRemoved = new core.EventEmitter();
            this.objectModified = new core.EventEmitter();
            this.objectSelected = new core.EventEmitter();
            this.objectMoving = new core.EventEmitter();
            this.objectScaling = new core.EventEmitter();
            this.objectSkewing = new core.EventEmitter();
            this.objectRotating = new core.EventEmitter();
            this.selectionCleared = new core.EventEmitter();
            this.selectionCreated = new core.EventEmitter();
            this.selectionUpdated = new core.EventEmitter();
            this.beforeTransform = new core.EventEmitter();
            this.beforeSelectionCleared = new core.EventEmitter();
        }
        ...
        function () {
            ...
            function () {
                if (!_this.disabled) {
                    _this.instance = new fabric.fabric.Canvas(_this.elementRef.nativeElement, params);
                }
                else {
                    _this.instance = new fabric.fabric.StaticCanvas(_this.elementRef.nativeElement, params);
                }
        ...
        FabricDirective.ctorParameters = function () { return [
            ...
            { type: undefined, decorators: [{ type: core.Optional }, { type: core.Inject, args: [FABRIC_CONFIG,] }] }
        ]; };
        FabricDirective.propDecorators = {
            ...
            config: [{ type: core.Input, args: ['fabric',] }],
            ...
            mousedblclick: [{ type: core.Output }],
            mouseupBefore: [{ type: core.Output }],
            mousedownBefore: [{ type: core.Output }],
            mousemoveBefore: [{ type: core.Output }],
            mouseUp: [{ type: core.Output }],
            mouseDown: [{ type: core.Output }],
            mouseOver: [{ type: core.Output }],
            mouseOut: [{ type: core.Output }],
            ...
            mouseDownBefore: [{ type: core.Output }],
            mouseMoveBefore: [{ type: core.Output }],
            pathCreated: [{ type: core.Output }],
            alterRender: [{ type: core.Output }],
            objectAdded: [{ type: core.Output }],
            objectMoved: [{ type: core.Output }],
            objectScaled: [{ type: core.Output }],
            objectSkewed: [{ type: core.Output }],
            objectRotated: [{ type: core.Output }],
            objectRemoved: [{ type: core.Output }],
            objectModified: [{ type: core.Output }],
            objectSelected: [{ type: core.Output }],
            objectMoving: [{ type: core.Output }],
            objectScaling: [{ type: core.Output }],
            objectSkewing: [{ type: core.Output }],
            objectRotating: [{ type: core.Output }],
            selectionCleared: [{ type: core.Output }],
            selectionCreated: [{ type: core.Output }],
            selectionUpdated: [{ type: core.Output }],
            beforeTransform: [{ type: core.Output }],
            beforeSelectionCleared: [{ type: core.Output }]
        };
    ...
    var FabricComponent = /** @class */ (function () {
        ...
        FabricComponent.propDecorators = {
            ...
            useFabricClass: [{ type: core.HostBinding, args: ['class.fabric',] }, { type: core.Input }],
            ...
            beforeTransform: [{ type: core.Output }],
            beforeSelectionCleared: [{ type: core.Output }],
            directiveRef: [{ type: core.ViewChild, args: [FabricDirective, { static: true },] }]
        };
    ...
    var FabricModule = /** @class */ (function () {
        ...
        FabricModule.decorators = [
            { type: core.NgModule, args: [{
                        ...
                        exports: [common.CommonModule, FabricComponent, FabricDirective],
                        providers: []
                    },] }
        ];
        return FabricModule;
    ...
    exports.FABRIC_CONFIG = FABRIC_CONFIG;
    exports.FabricComponent = FabricComponent;
    exports.FabricConfig = FabricConfig;
    exports.FabricDirective = FabricDirective;
    exports.FabricModule = FabricModule;

    Object.defineProperty(exports, '__esModule', { value: true });

})));
//# sourceMappingURL=ngx-fabric-wrapper.umd.js.map
